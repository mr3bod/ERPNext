...
def check_if_expired():
	...
	if limits.upgrade_url:
		...
		message = _("""Your subscription expired. To renew, {0}.""").format(get_upgrade_link(limits.upgrade_url))
	#elif support_email:
...
def get_upgrade_link(upgrade_url, label=None):
	upgrade_url = upgrade_url#get_upgrade_url(upgrade_url)
